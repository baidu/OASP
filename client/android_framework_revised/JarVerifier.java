...
import android.framework.org.apache.harmony.security_custom.utils.JarUtils;
...
class JarVerifier {
    ...
    class VerifierEntry extends OutputStream {
         ...
         *
         * @throws SecurityException if the digest value stored in the manifest does <i>not</i>
     ...
     *
     * @param name       the name of the JAR file being verified.
     * @param chainCheck whether to check the certificate chain signatures
     */
     ...
     *
     * @param name the name of an entry in a JAR file which is <b>not</b> in the
     ...
     *
     * @param name the name of the file located in the {@code META-INF}
     *             directory.
     * @param buf  the file bytes for the file called {@code name}.
     ...
     * signed.
     * @throws SecurityException if the JAR file is signed and it is determined that a
     ...
     *
     * @param mf a {@code java.util.jar.Manifest} object.
     */
     ...
     * {@code name}.
     *
     * @param name the name of a JAR entry.
     ...
     *
     * @param signatureFileName the name of a signature file.
     * @param certificates      a {@code Map} of all of the certificate chains discovered so
